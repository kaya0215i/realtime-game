...
public class ImpactBombController : WeaponManager {
    ...
    private void Start() {
        ...
        // サブ武器ごとに設定
        SubWeaponData subWeaponData = CharacterSettings.Instance.SWDSO.subWeaponDataList.First(_ => _.SubWeapon == PLAYER_SUB_WEAPON.ImpactBomb);
